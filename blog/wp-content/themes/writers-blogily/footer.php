...
<div class="site-info">
	...
	<span class="footer-info-right">
		<?php echo esc_html_e(' | Powered by', 'writers-blogily') ?> <a href="<?php echo esc_url('https://superbthemes.com/writers-blogily/', 'writers-blogily'); ?>" rel="nofollow noopener"><?php echo esc_html_e('Writers Blogily Theme', 'writers-blogily') ?></a>
	</span>
