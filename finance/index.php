...
<body>
  ...
  <header class="hero">
    <h1>Free <span>Finance Calculators</span></h1>
    <p>SIP, EMI, PPF, income tax, FD, RD and every other finance tool you need. No signup, no ads, your numbers never leave your browser.</p>
  </header>

  <main class="container">
    <div class="section-title">
      <h2>All Finance Tools</h2>
    ...
    <div class="section-title">
      ...
      <p>From India's top business news sources, updated automatically</p>
    </div>
    <div class="news-grid">
      <?php if (empty($news)): ?>
  ...
  <script>
    fetch('/assets/manifest.php', { cache: 'no-store' })
      ...
      .then(data => {
        ...
        const niche = (data.niches || []).find(n => n.key === 'finance');
        if (!niche || !niche.tools.length) {
          grid.innerHTML = '<p style="color:#94a3b8;grid-column:1/-1;text-align:center;">No finance tools found yet.</p>';
          return;
        }
