...
$urls[]=['url'=>SITE_URL.'/blog/','lastmod'=>$latestPostDate,'changefreq'=>'weekly','priority'=>'0.8'];
foreach($posts as $p){$urls[]=['url'=>SITE_URL.'/blog/'.$p['slug'],'lastmod'=>$p['date'],'priority'=>'0.7'];}
